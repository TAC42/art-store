...
export async function sendContactUsMail(req: Request<{}, {}, ContactUsRequestBody>, res: Response): Promise<void> {
...
export async function sendVerificationMail(req: Request<{}, {}, VerificationMailRequestBody>, res: Response): Promise<void> {
