...
export async function login(req: Request<any, any, LoginRequestBody>, res: Response): Promise<void> {
...
export async function signup(req: Request<any, any, SignupRequestBody>, res: Response): Promise<void> {
